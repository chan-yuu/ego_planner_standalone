...
namespace ego_planner
{
  ...
  {
    int order = 3;
    double lambda1 = 10.0;    // jerk smoothness weight
    double lambda2 = 5.0;     // distance weight
    double lambda3 = 0.00001; // feasibility weight
    double lambda4 = 0.01;    // curve fitting
    double dist0 = 0.4;       // safe distance
    double max_vel = 3.0;
    double max_acc = 3.0;
    int max_iteration_num = 100;
    double max_iteration_time = 0.02;
    double new_lambda2 = 1.0;
  };
